...
{
    public class CrossCellCommand : IEditorCommand
    {
        private readonly CellView _cellView;
        private readonly CellState _previousState;

        public CrossCellCommand(CellView cellView, CellState previousState)
        {
            _cellView = cellView;
            _previousState = previousState;
        }

        public void Execute() => _cellView.SetState(CellState.Crossed);
